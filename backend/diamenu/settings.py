...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', os.environ.get('RESEND_API_KEY', 'your-resend-api-key'))
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@diamenu.online')

# AI Settings
# In production, Cloud Run will provide this via GitHub secrets
# We check both VITE_GEMINI_API_KEY (existing) and GEMINI_API_KEY (standard)
