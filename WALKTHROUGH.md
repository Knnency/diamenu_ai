# DiaMenu - User Walkthrough

Welcome to **DiaMenu**, your AI-powered dietary assistant designed specifically for Filipino diabetics. This guide will walk you through the main features of the application and how to use them effectively to manage your diet and blood sugar.
...
2. **Enter your meal:** In the text box labeled "What are you eating?", type in a description of your meal or paste a full recipe. 
   * *Example:* "Sinigang na Baboy with 2 cups of white rice and a glass of mango juice."
3. **Start the Audit:** Click the **"Start AI Audit"** button.
4. **Wait for the Analysis:** You will see a loading screen indicating that the Doctor and Chef agents are analyzing your food's macros, glycemic index (GI), and searching for local market swaps.
5. **Review the Report:**
