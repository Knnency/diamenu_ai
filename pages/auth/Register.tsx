        ...
        <div className="hidden lg:flex w-[60%] relative flex-col justify-center items-start p-16 xl:p-24 overflow-hidden bg-primary/5 dark:bg-primary/10">
          ...
          <div className={`relative z-10 max-w-2xl opacity-0 ${mounted ? 'animate-fade-up' : ''}`}>
            ...
            <p className="text-lg xl:text-xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed max-w-xl">
              Join DiaMenu to access personalized meal plans, comprehensive nutritional audits, and a smarter way to track your diet.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-sm">
            ...
            <form className={`space-y-5 opacity-0 ${mounted ? 'animate-fade-up delay-200' : ''}`} onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div className="group relative">
                  <label htmlFor="name" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5 transition-colors group-focus-within:text-primary dark:group-focus-within:text-accent">Full Name</label>
                  <input
                ...
                <div className="group relative">
                  <label htmlFor="confirmPassword" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5 transition-colors group-focus-within:text-primary dark:group-focus-within:text-accent">Confirm Password</label>
                  <input
            ...
            <div className={`mt-8 text-center text-sm opacity-0 ${mounted ? 'animate-fade-up delay-400' : ''}`}>
              <p className="text-gray-500 dark:text-gray-400">
                ...
                <button onClick={() => changeView(ViewState.LOGIN)} className="font-semibold text-primary hover:text-teal-700 dark:text-accent dark:hover:text-lime-400 transition-colors bg-transparent border-b border-transparent hover:border-primary dark:hover:border-accent">
                  Sign in
                </button>
              </p>
            </div>
